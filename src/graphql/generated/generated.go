...
var sources = []*ast.Source{
	{Name: "../schema/profile/profile.graphqls", Input: `# GraphQL schema example
#
...
func (ec *executionContext) field_Mutation_createProfile_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNcreateProfileInput2adtecᚋbackendᚋsrcᚋgraphqlᚋmodelᚐCreateProfileInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createProfile(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProfile2ᚖadtecᚋbackendᚋsrcᚋgraphqlᚋmodelᚐProfile(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Profile_fullName(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Profile",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) fieldContext_Profile_birthDate(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Profile",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Profile_deletedAt(ctx context.Context, field graphql.CollectedField, obj *model.Profile) (ret graphql.Marshaler) {
...
func (ec *executionContext) unmarshalInputcreateProfileInput(ctx context.Context, obj interface{}) (model.CreateProfileInput, error) {
	...
	fieldsInOrder := [...]string{"userId", "fullName", "birthDate", "country", "address", "city"}
...
func (ec *executionContext) marshalNProfile2adtecᚋbackendᚋsrcᚋgraphqlᚋmodelᚐProfile(ctx context.Context, sel ast.SelectionSet, v model.Profile) graphql.Marshaler {
	return ec._Profile(ctx, sel, &v)
}

func (ec *executionContext) marshalNProfile2ᚖadtecᚋbackendᚋsrcᚋgraphqlᚋmodelᚐProfile(ctx context.Context, sel ast.SelectionSet, v *model.Profile) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNcreateProfileInput2adtecᚋbackendᚋsrcᚋgraphqlᚋmodelᚐCreateProfileInput(ctx context.Context, v interface{}) (model.CreateProfileInput, error) {
